  ...
  return (
    <div className='flex flex-col items-center  h-screen p-48 gap-10 '>
      ...
      <ul className='flex text-xl w-2/6 justify-between '>
        <Button variant={'outline'} className='text-xl px-10 py-2 bg-[#209CFF] rounded-full text-white'>
          <Link href="/produits">Produits</Link>
        </Button>
        <Button variant={'outline'} className='text-xl px-10 py-2 bg-[#FF724F] rounded-full text-white '>
